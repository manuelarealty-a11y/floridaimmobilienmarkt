  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 rounded-2xl border border-stone-200 bg-white p-8 shadow-sm">
      ...
      <div>
        ...
        <input required type="text" className="mt-1 w-full rounded-lg border border-stone-300 px-4 py-2.5 text-sm focus:border-[#0f6b5c] focus:outline-none" />
      </div>
      <div>
        <label className="text-sm font-medium text-stone-700">E-Mail-Adresse *</label>
        <input required type="email" className="mt-1 w-full rounded-lg border border-stone-300 px-4 py-2.5 text-sm focus:border-[#0f6b5c] focus:outline-none" />
      </div>
      <div>
        <label className="text-sm font-medium text-stone-700">Telefon / WhatsApp</label>
        <input type="tel" className="mt-1 w-full rounded-lg border border-stone-300 px-4 py-2.5 text-sm focus:border-[#0f6b5c] focus:outline-none" />
      </div>
      <div>
        <label className="text-sm font-medium text-stone-700">Interessiert an</label>
        <select className="mt-1 w-full rounded-lg border border-stone-300 px-4 py-2.5 text-sm focus:border-[#0f6b5c] focus:outline-none">
      ...
      <div>
        ...
        <textarea required rows={4} className="mt-1 w-full rounded-lg border border-stone-300 px-4 py-2.5 text-sm focus:border-[#0f6b5c] focus:outline-none" />
      </div>
